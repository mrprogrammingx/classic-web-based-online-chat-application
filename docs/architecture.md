# Classic Web-Based Online Chat Application — Architecture & Full Spec
...
The following screenshots show key UI views (right panel contains account, friends, incoming requests, and sessions):
...
Chat page (emoji picker and message bubbles):

![Chat page screenshot](./screenshots/chat-picker.png)

Rooms list page:

![Rooms page screenshot](./screenshots/rooms.png)

Admin console (users list and session menu):

![Admin page screenshot](./screenshots/admin.png)

Room members / sidebar:

![Room members screenshot](./screenshots/members.png)

Manage room modal (admins view recent messages, ban/unban):
